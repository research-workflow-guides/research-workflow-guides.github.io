...
<figure class="image-frame">
  <img src="/assets/images/legacy/github-workflow/conflict-merge-state.png" alt="merge 중인 VS Code Source Control 상태">
  <figcaption>merge를 정리한 뒤에는 repository 상태가 다시 정상적인 staged 상태로 돌아와야 합니다.</figcaption>
</figure>
