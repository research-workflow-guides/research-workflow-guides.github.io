...
<div class="doc-section-grid">
  <div>
    <p>GitHub import entry에서 시작한 뒤, 이미 LaTeX manuscript가 들어 있는 repository를 선택합니다. Overleaf project는 로컬에서 쓰는 것과 같은 저장소를 가리켜야 합니다.</p>
  </div>
...
<div class="doc-section-grid">
  <div>
    <p>핵심은 round-trip consistency입니다. Overleaf 수정이 같은 GitHub 저장소로 돌아가야 로컬 VS Code와 브라우저 작성이 서로 다른 역사로 갈라지지 않습니다.</p>
  </div>
  <div class="figure-stack">
    <figure class="image-frame">
